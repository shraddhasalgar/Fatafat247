                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int a= 0; jsonArray.length()>a;a++)
                            {
                                ...
                                remark1.add(jsonObject.getString("type"));

                                adaptertransaction rc = new adaptertransaction(transactions.this,date,remark,amount,type,remark1);
