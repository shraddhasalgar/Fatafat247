...
public class starline_timings extends AppCompatActivity {
    ...
    private LinearLayout resultHistoryPop,starlinel;
...
//        title.setText(market);
        ...
        back2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                starlinel.setVisibility(View.VISIBLE);
        ...
        resultHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                starlinel.setVisibility(View.GONE);
    ...
    private void apicall2() {
        ...
        final StringRequest postRequest = new StringRequest(Request.Method.POST, url2,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Log.e("dataaa", ""+jsonObject1.getJSONArray("data"));
                            ...
                            adapter_starline_results rc2 = new adapter_starline_results(time, result);
            ...
            protected Map<String, String> getParams() {
                ...
                Log.d("sess",""+ getSharedPreferences(constant.prefs, MODE_PRIVATE).getString("session", null));
                params.put("market", market);
                Log.d("market11",""+ market);
    ...
    private void initViews() {
        ...
        starlinel = findViewById(R.id.starlinel);
    }
}
