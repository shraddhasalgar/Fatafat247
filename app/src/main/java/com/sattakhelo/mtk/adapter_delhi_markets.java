...
class adapter_delhi_markets extends RecyclerView.Adapter<adapter_delhi_markets.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.market_delhi_layout_2, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        try {
            ...
            holder.timer4.start(timeInMilliseconds-System.currentTimeMillis());
            //System.out.println("started");
            holder.timer4.setOnCountdownIntervalListener(1, new CountdownView.OnCountdownIntervalListener() {
                @Override
